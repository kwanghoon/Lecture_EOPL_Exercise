...
parserSpec = ParserSpec
  {
    ...
    baseDir        = "./",
    actionTblFile  = "action_table_letreccps.txt",
    gotoTblFile    = "goto_table_letreccps.txt",
    grammarFile    = "prod_rules_letreccps.txt",
    parserSpecFile = "mygrammar_letreccps.grm",
